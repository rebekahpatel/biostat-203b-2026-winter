...
```{r}
patient_vitals <- open_dataset("../hw2/pq_chart", format = "parquet") |>
  to_duckdb() |>
...
ggplot(patient_vitals, aes(x = charttime, y = valuenum, color = factor(itemid))) +
  geom_line() +
  geom_point() +
...
icustays_tble |>
  ...
  labs(title = "Number of ICU Stays per Subject ID", x = "Number of ICU Stays", y = "Count of Subject IDs")
```
