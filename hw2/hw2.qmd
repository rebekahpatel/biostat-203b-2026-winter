...
system.time(readr::read_csv("~/mimic/hosp/admissions.csv.gz"))
system.time(data.table::fread("~/mimic/hosp/admissions.csv.gz"))

```
**Solution:** The fastest function is `fread` as it takes the user 1.057 seconds. The 
```{r}
object_size(read.csv("~/mimic/hosp/admissions.csv.gz"))
object_size(readr::read_csv("~/mimic/hosp/admissions.csv.gz"))
object_size(data.table::fread("~/mimic/hosp/admissions.csv.gz"))
```
