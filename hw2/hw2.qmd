...
```{bash}
#ln -s /Volumes/NOV2025/mimic-iv-3.1 ~/mimic
...
gzcat < ~/mimic/hosp/labevents.csv.gz | 
  awk -F, 'NR>1 || $5==50862 || $5==50912 || $5==50971 || $5==50983 || $5==50902 || $5==50882 ||
  $5==51221 || $5==51301 || $5==50931 {print $2, $5, $7 ,$10}' | gzip > ~/BIOSTAT203B/203b-hw/hw2/labevents_filtered.csv.gz
